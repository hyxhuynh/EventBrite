    ...
    public class CatalogSeed
    {
        ...
        private static IEnumerable<CatalogEvent> GetPreConfiguredCatalogEvents()
        {
            return new List<CatalogEvent>()
            {
                ...
                new CatalogEvent() {CatalogTypeId=5, CatalogCategoryId=4, CatalogEventCityId=1, CatalogEventZipcodeId=1, Description = "Test2", Name = "Test2", Price = 40, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pics/9", Address1 = "4006 Feiner Drive", Address2 = "", State = "WA", EventDateTime = new DateTime(2019, 9, 5, 2, 30, 0)},

               // Performance, Music, Seattle, 98134, using categoryid 6 for test
                new CatalogEvent() {CatalogTypeId=5, CatalogCategoryId=4, CatalogEventCityId=1, CatalogEventZipcodeId=1, Description = "Test2", Name = "Test3", Price = 40, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pics/10", Address1 = "4006 Feiner Drive", Address2 = "", State = "WA", EventDateTime = new DateTime(2019, 9, 5, 2, 30, 0)}
            };
